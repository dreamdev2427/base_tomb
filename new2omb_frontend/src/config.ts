...
const configurations: { [env: string]: Configuration } = {
  production: {
    ...
    externalTokens: {
      ...
      'ARBT-WFTM LP': ['0x83A52eff2E9D112E9B022399A9fD22a9DB7d33Ae', 18],
...
export const bankDefinitions: { [contractName: string]: BankInfo } = {
  ...
  */
  Tomb2sharesRewardPool: {
    name: 'Earn ARBT by staking 2SHARES',
    poolId: 0,
    sectionInUI: 0,
  ...
  Tomb2sharesWftmLPRewardPool: {
    name: 'Earn ARBT by staking 2SHARES-WFTM LP',
    poolId: 1,
    sectionInUI: 0,
  ...
  //   name: 'Earn ARBT by staking 2OMB-2SHARES LP',
  //   poolId: 2,
  //   sectionInUI: 0,
  ...
  Tomb2ombWftmLPRewardPool: {
    name: 'Earn ARBT by staking 2OMB-WFTM LP',
    poolId: 2,
    sectionInUI: 0,
  ...
  Tomb2ombRewardPool: {
    name: 'Earn ARBT by staking 2OMB',
    poolId: 3,
    sectionInUI: 0,
  ...
  TombBelugaRewardPool: {
    name: 'Earn ARBT by staking BELUGA',
    poolId: 4,
    sectionInUI: 0,
  ...
  TombBifiRewardPool: {
    name: 'Earn ARBT by staking BIFI',
    poolId: 5,
    sectionInUI: 0,
  ...
  TombWrappedFtmRewardPool: {
    name: 'Earn ARBT by staking WFTM',
    poolId: 6,
    sectionInUI: 0,
  ...
  TombBloomRewardPool: {
    name: 'Earn ARBT by staking BLOOM',
    poolId: 8,
    sectionInUI: 0,
  ...
  Tomb2SHARESFTMRebates: {
    name: 'Bond 2SHARES-WFTM LP, earn ARBT',
    poolId: 2,
    sectionInUI: 3,
    contract: 'TombFtmRewardPool',
    depositTokenName: '2SHARES-WFTM LP',
  ...
  // Tomb3OMBFTMRebates: {
  //   name: 'Bond ARBT-WFTM LP, earn ARBT',
  //   poolId: 3,
  //   sectionInUI: 3,
  //   contract: 'TombFtmRewardPool',
  //   depositTokenName: 'ARBT-WFTM LP',
  ...
  // name: 'Bond ARBSHARES-WFTM LP, earn ARBT',
  // poolId: 5,
  // sectionInUI: 3,
  //  contract: 'TombFtmRewardPool',
  //  depositTokenName: 'ARBSHARES-WFTM LP',
