...
const configurations: { [env: string]: Configuration } = {
  production: {
    ...
    externalTokens: {
      ...
      wETH: ['0x82aF49447D8a07e3bd95BD0d56f35241523fBab1', 18],
      'BOMB-WETH LP': ['0x1dE807C94D1637be2267A937fd5aB07a16c30579', 18],
      'BSHARE-WETH LP': ['0x082a88164A4c06076a844AB120716EB3925908F2', 18],
      'BSHARE-USDC LP': ['0x1b39a46aad891175af2e0F63Ef7E0F8a4313F235', 18],

      BSHARE: ['0x9664E90eb98Be3671E940e42aFdEd1B56c364185', 18],
      'USDC-ETH-LP': ['0x84652bb2539513BAf36e225c930Fdd8eaa63CE27', 18],

      'BOMB-ETH-LP': ['0x1dE807C94D1637be2267A937fd5aB07a16c30579', 18],
      'BSHARE-ETH-LP': ['0x082a88164A4c06076a844AB120716EB3925908F2', 18],

      'BOMB-USDC-LP': ['0xEd2B3f61CB03a17FF9CBb2D34E1B69E25774B489', 18],
      'BSHARE-USDC-LP': ['0x1b39a46aad891175af2e0F63Ef7E0F8a4313F235', 18],
    },
...
export const bankDefinitions: { [contractName: string]: BankInfo } = {
  ...
  */
  TombWrappedEthRewardPool: {
    name: 'Earn BOMB by staking WETH',
    poolId: 3,
    sectionInUI: 0,
    ...
    buyLink: 'https://app.rocketswap.cc/exchange',
    sort: 7,
  ...
  TombEthLPTombRewardPool: {
    name: 'Earn BOMB by BOMB-ETH LP',
    poolId: 0,
    sectionInUI: 1,
    contract: 'TombEthLpTombRewardPool',
    depositTokenName: 'BOMB-ETH-LP',
    earnTokenName: 'TOMB',
    finished: false,
    multiplier: '0',
    buyLink: 'https://app.rocketswap.cc/exchange',
  ...
  TombUSDCLPTShareRewardPool: {
    name: 'Earn BSHARE by USDC',
    poolId: 2,
    sectionInUI: 2,
    contract: 'TombUSDCLPTShareRewardPool',
    depositTokenName: 'BSHARE-USDC LP',
  ...
  TshareEthLPTShareRewardPool: {
    name: 'Earn BSHARE by BSHARE-WETH LP',
    poolId: 0,
    sectionInUI: 2,
  ...
  // },
  // Tomb3OMBETHRebates: {
  //   name: 'Bond BOMB-WETH LP, earn BOMB',
  //   poolId: 3,
  //   sectionInUI: 3,
  //   contract: 'TombEthRewardPool',
  //   depositTokenName: 'BOMB-WETH LP',
  ...
  // name: 'Bond BSHARE-WETH LP, earn BOMB',
  // poolId: 5,
  // sectionInUI: 3,
  //  contract: 'TombEthRewardPool',
  //  depositTokenName: 'BSHARE-WETH LP',
