...
const configurations: { [env: string]: Configuration } = {
  production: {
    ...
    externalTokens: {
      ...
      'ARBTOMB-WFTM LP': ['0x83A52eff2E9D112E9B022399A9fD22a9DB7d33Ae', 18],
      'ARBSHARES-WFTM LP': ['0xd352daC95a91AfeFb112DBBB3463ccfA5EC15b65', 18],
...
export const bankDefinitions: { [contractName: string]: BankInfo } = {
  ...
  */
  ...
  Tomb2sharesWftmLPRewardPool: {
    name: 'Earn ARBTOMB by staking 2SHARES-WFTM LP',
    poolId: 1,
    sectionInUI: 0,
  ...
  Tomb2ombWftmLPRewardPool: {
    name: 'Earn ARBTOMB by staking 2OMB-WFTM LP',
    poolId: 2,
    sectionInUI: 0,
  ...
  TombWrappedFtmRewardPool: {
    name: 'Earn ARBTOMB by staking WFTM',
    poolId: 6,
    sectionInUI: 0,
  ...
  TshareFtmLPTShareRewardPool: {
    name: 'Earn ARBSHARES by ARBSHARES-WFTM LP',
    poolId: 1,
    sectionInUI: 2,
  ...
  TwoshareFtmLPTShareRewardPool: {
    name: 'Earn ARBSHARES by 2SHARES-WFTM LP',
    poolId: 2,
    sectionInUI: 2,
  ...
  TwoombFtmLPTShareRewardPool: {
    name: 'Earn ARBSHARES by 2OMB-WFTM LP',
    poolId: 3,
    sectionInUI: 2,
  ...
  Tomb2SHARESFTMRebates: {
    name: 'Bond 2SHARES-WFTM LP, earn ARBTOMB',
    poolId: 2,
    sectionInUI: 3,
    contract: 'TombFtmRewardPool',
    depositTokenName: '2SHARES-WFTM LP',
  ...
  // Tomb3OMBFTMRebates: {
  //   name: 'Bond ARBTOMB-WFTM LP, earn ARBTOMB',
  //   poolId: 3,
  //   sectionInUI: 3,
  //   contract: 'TombFtmRewardPool',
  //   depositTokenName: 'ARBTOMB-WFTM LP',
  ...
  // name: 'Bond ARBSHARES-WFTM LP, earn ARBTOMB',
  // poolId: 5,
  // sectionInUI: 3,
  //  contract: 'TombFtmRewardPool',
  //  depositTokenName: 'ARBSHARES-WFTM LP',
