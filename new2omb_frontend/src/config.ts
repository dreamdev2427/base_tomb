...
const configurations: { [env: string]: Configuration } = {
  production: {
    ...
    externalTokens: {
      WETH: ['0x21be370d5312f44cb42ce377bc9b8a0cef1a4c83', 18],
      ...
      '2OMB-WETH LP': ['0xbdC7DFb7B88183e87f003ca6B5a2F81202343478', 18],
      '2SHARES-WETH LP': ['0x6398ACBBAB2561553a9e458Ab67dCFbD58944e52', 18],
      '2SHARES': ['0xc54A1684fD1bef1f077a336E6be4Bd9a3096a6Ca', 18],
      'ARBTOMB-WETH LP': ['0x83A52eff2E9D112E9B022399A9fD22a9DB7d33Ae', 18],
      'ARBSHARES-WETH LP': ['0xd352daC95a91AfeFb112DBBB3463ccfA5EC15b65', 18],
      'ARBSHARES': ['0x6437ADAC543583C4b31Bf0323A0870430F5CC2e7', 18],
      'USDT-ETH-LP': ['0x2b4C76d0dc16BE1C31D4C1DC53bF9B45987Fc75c', 18],
      'TOMB-ETH-LP': ['0x83a52eff2e9d112e9b022399a9fd22a9db7d33ae', 18],
      'TSHARE-ETH-LP': ['0xd352dac95a91afefb112dbbb3463ccfa5ec15b65', 18],
    },
...
export const bankDefinitions: { [contractName: string]: BankInfo } = {
  ...
  */
  Tomb2sharesRewardPool: {
    name: 'Earn ARBTOMB by staking 2SHARES',
    poolId: 0,
    sectionInUI: 0,
    contract: 'Tomb2ShareRewardPool',
    depositTokenName: '2SHARES',
    earnTokenName: 'ARBTOMB',
    finished: false,
    multiplier: '7500x',
  ...
  Tomb2sharesWftmLPRewardPool: {
    name: 'Earn ARBTOMB by staking 2SHARES-WETH LP',
    poolId: 1,
    sectionInUI: 0,
  ...
  //   name: 'Earn ARBTOMB by staking 2OMB-2SHARES LP',
  //   poolId: 2,
  //   sectionInUI: 0,
  ...
  Tomb2ombWftmLPRewardPool: {
    name: 'Earn ARBTOMB by staking 2OMB-WETH LP',
    poolId: 2,
    sectionInUI: 0,
  ...
  Tomb2ombRewardPool: {
    name: 'Earn ARBTOMB by staking 2OMB',
    poolId: 3,
    sectionInUI: 0,
  ...
  TombBelugaRewardPool: {
    name: 'Earn ARBTOMB by staking BELUGA',
    poolId: 4,
    sectionInUI: 0,
  ...
  TombBifiRewardPool: {
    name: 'Earn ARBTOMB by staking BIFI',
    poolId: 5,
    sectionInUI: 0,
  ...
  TombWrappedFtmRewardPool: {
    name: 'Earn ARBTOMB by staking WETH',
    poolId: 6,
    sectionInUI: 0,
  ...
  TombMimRewardPool: {
    name: 'Earn ARBTOMB by staking MIM',
    poolId: 7,
    sectionInUI: 0,
  ...
  TombBloomRewardPool: {
    name: 'Earn ARBTOMB by staking BLOOM',
    poolId: 8,
    sectionInUI: 0,
  ...
  TshareFtmLPTShareRewardPool: {
    name: 'Earn ARBSHARES by ARBSHARES-WETH LP',
    poolId: 1,
    sectionInUI: 2,
  ...
  // },
  Tomb2SHARESRebates: {
    name: 'Bond 2SHARES, earn ARBTOMB',
    poolId: 0,
    sectionInUI: 3,
  ...
  Tomb2SHARESFTMRebates: {
    name: 'Bond 2SHARES-WETH LP, earn ARBTOMB',
    poolId: 2,
    sectionInUI: 3,
    contract: 'TombFtmRewardPool',
    depositTokenName: '2SHARES-WETH LP',
  ...
  // Tomb3OMBFTMRebates: {
  //   name: 'Bond ARBTOMB-WETH LP, earn ARBTOMB',
  //   poolId: 3,
  //   sectionInUI: 3,
  //   contract: 'TombFtmRewardPool',
  //   depositTokenName: 'ARBTOMB-WETH LP',
  ...
  // },
  Tomb3SHARESRebates: {
    name: 'Bond ARBSHARES, earn ARBTOMB',
    poolId: 4,
    sectionInUI: 3,
    contract: 'TombFtmRewardPool',
  ...
  // name: 'Bond ARBSHARES-WETH LP, earn ARBTOMB',
  // poolId: 5,
  // sectionInUI: 3,
  //  contract: 'TombFtmRewardPool',
  //  depositTokenName: 'ARBSHARES-WETH LP',
