...
function useTotalTreasuryBalance() {
    ...
    return { balance, balance_2shares_weth, balance_3omb_weth, balance_3shares_weth, balance_3omb, balance_3shares, balance_2shares }
    ...
    async function getLPPrice(LPAddress, tokenAddress) {
        ...
        const OneTokenValue = (wethValue + tokenValue) / Number(web3.utils.fromWei(await LPtoken.methods.totalSupply().call()))
